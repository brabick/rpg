...
player2_mon_list = [
    mon('Trainer Joey\'s Charizard', fire, None, 50, 10, 10, char_attacks),
    mon('Trainer Joey\'s Blastoise', water, None, 50, 10, 9, blas_attacks),
    mon('Trainer Joey\'s Venusaur', grass, None, 50, 10, 10, ven_attacks)
]
